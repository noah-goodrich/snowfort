...
### AC-1: Zero Silent Exception Swallowing
...
### AC-3: CDC Noise Reduction via Configurable Regex
...
### AC-4: Violation Categorization + Adjusted Scoring
...
### AC-5: Cortex-Native Manifest Enrichment
...
- [Directive B: Warehouse Sizing & Cost Optimization](docs/plans/directives/warehouse-sizing.md)
- [Directive C: RBAC Topology & Role Hierarchy](docs/plans/directives/rbac-topology.md)
- [Directive D: Sensitive Data Detection](docs/plans/directives/sensitive-data-detection.md)
- [Directive E: IaC Drift + dbt Grants](docs/plans/directives/iac-drift-dbt-grants.md)
- [Directive F: Cortex AI Governance](docs/plans/directives/cortex-ai-governance.md)

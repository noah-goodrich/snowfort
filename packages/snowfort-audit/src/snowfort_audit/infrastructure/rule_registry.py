...
def get_all_rules(
    ...
    return [
        ...
        # Security
        # SEC_001 (AdminExposureCheck) is retired — replaced by Directive C rules below.
        ...
        UnmaskedSensitiveColumnsCheck(conventions=conventions, telemetry=telemetry),
        UntaggedSensitiveColumnsCheck(conventions=conventions, telemetry=telemetry),
        NoRowPolicyOnSensitiveTableCheck(conventions=conventions, telemetry=telemetry),
        OverPermissiveSensitiveAccessCheck(conventions=conventions, telemetry=telemetry),
        ContentPiiDetectionCheck(conventions=conventions, telemetry=telemetry),
        # Reliability
        ...
        *get_cortex_governance_rules(conventions=conventions, telemetry=telemetry),
        ...
        WorkloadIsolationCheck(conventions=conventions, telemetry=telemetry),
        AutoSuspendOptimizationCheck(conventions=conventions, telemetry=telemetry),
        ConsolidationCandidatesCheck(conventions=conventions, telemetry=telemetry),
        ...
        # Directive C — RBAC topology & role hierarchy (SEC_001a–d, SEC_024–029)
        AdminGrantCountCheck(conventions=conventions, telemetry=telemetry),
        DormantAdminAccountsCheck(conventions=conventions, telemetry=telemetry),
        AdminAsDefaultRoleCheck(conventions=conventions, telemetry=telemetry),
        LegacyIdentityDuplicationCheck(conventions=conventions, telemetry=telemetry),
        OrphanRoleRatioCheck(conventions=conventions, telemetry=telemetry),
        GodRoleDetectionCheck(conventions=conventions, telemetry=telemetry),
        PrivilegeConcentrationCheck(conventions=conventions, telemetry=telemetry),
